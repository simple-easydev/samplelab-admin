...
export default function EditPopupModal({
  ...
  // Pre-populate form when popup changes
  useEffect(() => {
    if (popup) {
      setFormData({
        active: popup.active,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error(error.message || "Failed to update pop-up");
    } finally {
    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Update the pop-up announcement details.
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              disabled={hasOtherActivePopup && !popup?.active}
            />
          </div>

          {hasOtherActivePopup && !popup?.active && (
