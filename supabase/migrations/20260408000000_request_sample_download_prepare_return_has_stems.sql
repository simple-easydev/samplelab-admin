-- Edge Function `request-sample-download` needs `has_stems` to sign `full.zip` when available.
...
BEGIN
  ...
  INTO v_name, v_audio_url, v_has_stems, v_cost, v_sample_status, v_pack_status, v_is_premium
  FROM public.samples s
