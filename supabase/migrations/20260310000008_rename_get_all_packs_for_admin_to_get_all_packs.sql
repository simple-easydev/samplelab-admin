...
COMMENT ON FUNCTION public.get_all_packs() IS
  'Returns all packs with creator_name, category_name, genres array, and samples_count. For admin library Packs tab.';

GRANT EXECUTE ON FUNCTION public.get_all_packs() TO authenticated;
GRANT EXECUTE ON FUNCTION public.get_all_packs() TO service_role;
