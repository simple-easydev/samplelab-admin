-- Include credit_cost in get_all_samples response (admin library samples list)
...
COMMENT ON FUNCTION public.get_all_samples(text, text, text[], text[], text, text, text, text[], text, integer, integer, integer, integer, integer) IS
  'Returns samples with optional filters and sort. Includes credit_cost for the admin library Samples tab.';
