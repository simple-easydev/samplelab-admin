-- Use app_settings credit rules (by sample type) for download debits
...
COMMENT ON FUNCTION public.request_sample_download_prepare(uuid, uuid, uuid) IS
  'Debit credits using app_settings credit_rules by sample type, write credit_activity, and record download.';
